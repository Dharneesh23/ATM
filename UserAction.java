...
//                    int notes= note.getNoteValue();
//                    switch (notes){
//                        case 2000,500,200,100:
//                            amt= perform_Withdrawal(amt,Note_tr,note);//to perform the withdraw method
//                            break;
//                    }
//                }
//                if(amt==0) {
//                    user.setBalance(user.getBalance()-amount);//to get the user balance and sub to withdraw amount
//                    ATM.setatmbalance(ATM.getatmbalance()-amount);//to get the atm balance and sub to withdraw amount
//                    for (String notes:Note_tr){
//                        System.out.println(notes);
//                    }
//                    Transaction transaction = new Transaction("Withdraw", amount,account.getId());//transation to add the perform amount to added to transation
...
//        }
//
//        public static double perform_Withdrawal(double Amount, ArrayList<String> note_Tr, Notes note){//perform withdraw method
//             int count = (int) Amount /note.getNoteValue();
//            if (note.getNoteValue()<=Amount&&count<= note.getNoteCount()){
//                Amount=Amount-(count*note.getNoteValue());
//                note.setNoteCount( (note.getNoteCount()-count));
//                note_Tr.add("You got "+note.getNoteValue()+" count "+count);
//                return Amount;
//            }
//            return Amount;
//        }
            ...
            while (amount != 0) {
                ...
                for (Notes note : Note_Dp) {
                    ...
                    //  Check which denomination is being attempted
//                System.out.println("Trying to withdraw with denomination: " + noteValue);
//                System.out.println("Available notes: " + availableNotes);
//                System.out.println("Required notes: " + requiredNotes);
